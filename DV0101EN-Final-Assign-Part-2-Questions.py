...
app.layout = html.Div([
    ...
    html.H1(children = "Automobile Sales Statistics Dashboard", style = {'textAlign':'left','color':'#000000','font-size':0}),
...
def update_input_container(selected_statistics):
    if selected_statistics == 'Yearly Statistics': 
        return False # This enables the dropdown
    else: 
        return True  # This disables the dropdown
